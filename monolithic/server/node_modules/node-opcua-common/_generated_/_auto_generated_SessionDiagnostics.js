// --------- This code has been automatically generated !!! 2019-05-13T22:01:02.017Z
"use strict";
/**
...
function SessionDiagnostics(options)
{
    ...
    /**
      ...
      * @type {String[]}
      */
    self.localeIds = initialize_field_array(schema.fields[5], options.localeIds);
...
SessionDiagnostics.prototype.encode = function(stream,options) {
   ...
   this.clientDescription.encode(stream,options);
    ...
    encodeArray(this.localeIds, stream, encode_String);
...
SessionDiagnostics.prototype.decode = function(stream) {
    ...
    this.localeIds = decodeArray(stream, decode_String);
